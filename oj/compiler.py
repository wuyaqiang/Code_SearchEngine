...
# import _judger
#
# from .configure import COMPILER_LOG_PATH
...
#         """
#         :param compile_config: language configuration for compile
#         :param src_path: absolute path for source code file
#         :param output_dir: directory where to put executable
#         :return:
#         """
