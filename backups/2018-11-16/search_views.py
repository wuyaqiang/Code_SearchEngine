...
from .code_processing.tokenize import highlight_words, lex_analysis, lex_analysis_char
...
char_suffix_tree = build_N_STree(lex_char_text[:])
lex_suffix_tree = build_N_STree(lex_text[:])
